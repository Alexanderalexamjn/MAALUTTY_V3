...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖 munavir💖' : process.env.OWNER_NAME,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'munavir' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Munusir bot' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '918590822912@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Munusir bot' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 Munusirbot 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Munusir' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '918590822912,917994909899,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUPPORT: "918590822912-1635775355",
