/* Copyright (C) 2021 MUNAVIR
Licensed under the  GPL-3.0 License;
Mwonu munusirinde credits kalayalle
ᴍᴜɴᴜꜱɪʀ - мυиανιя
*/
const ᴍᴜɴᴜꜱɪʀ = require('../events');
